...
#Play_Role(str)
#Play_Role(str2)
Play_Role(str4,['aircondition.power','blind','window','weather','humidity','volume','light.intensity','heater.level','aircondition.mode','time','outside.temperature','aircondition.level'])
rolelist.Show()
